...
//
// font.rs — 8×8 bitmap font, ASCII 0x20-0x7F
//
// Shared between framebuffer.rs (normal console) and hv_console.rs
// (EL2 fault display), so it lives in its own module.

#[rustfmt::skip]
pub(crate) static FONT: [[u8; 8]; 96] = [
